...
const double mediumWindowBreakpoint = 1000;
const double largeWindowBreakpoint = 1200;
const double compactWindowBreakpoint = 600;

class ScreenSizeService {
  //Avoid magic numbers by having a const variable.

  static bool isWideScreen(BuildContext context) {
    final windowSize = MediaQuery.sizeOf(context);
    return windowSize.width >= mediumWindowBreakpoint;
  }
}
